...
- [macOS Window Tiling Shortcuts](./macos-window-tiling.mdx) -- if you have a Window submenu, you must register it with `set_as_windows_menu_for_nsapp()` for macOS tiling to work
